...
namespace SE456
{
    class SpriteAnimationCmd : Command
    {
        public SpriteAnimationCmd(SpriteGame.Name spriteName, TimerEvent.Name _name)
        {
        ...
        public override void Execute(Delta deltaTime)
        {
            ...
            TimerEventMan.AddBasedOnTriggerTime(this.timerName, this, deltaTime);
        }
        ...
        private TimerEvent.Name timerName;
    }

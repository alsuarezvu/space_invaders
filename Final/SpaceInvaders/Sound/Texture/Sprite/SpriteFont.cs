    ...
    public class SpriteFont : SpriteBase
    {
        ...
        override public void Render()
        {
            ...
            for (int i = 0; i < this.pMessage.Length; i++)
            {
                ...
                //multiply width and height by 3, except for spaces where width is 3
                float width = key == 32 ? 3 : pGlyph.GetAzulRect().width * 3;
                float height = pGlyph.GetAzulRect().height * 3;

                xTmp = xEnd + width / 2;
                this.poScreenRect.Set(xTmp, yTmp, width, height);

...
namespace SE456
{
    public class FontMan : ManBase
    {
        ...
        public static void Create(int reserveNum = 3, int reserveGrow = 1)
        {
            ...
            if (psInstance == null)
            {
                psInstance = new FontMan(reserveNum, reserveGrow);
            }
        }
        ...
        public static Font Add(Font.Name name, SpriteBatch _SB, string pMessage, Glyph.Name glyphName, float xStart, float yStart)
        {
